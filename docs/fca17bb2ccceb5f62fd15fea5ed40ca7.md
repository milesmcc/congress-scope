...
## `fca17bb2ccceb5f62fd15fea5ed40ca7`
`Mr. McCONNELL — 24 June 2008`
...
described, and with which he is trying to deal as we move through the 
week. But my goal is really the same as his, and we are going to 
continue talking to each other, continue to sort of run the traps


and hopefully clear the traps in such a way that we can have a highly 
successful week before the recess.
